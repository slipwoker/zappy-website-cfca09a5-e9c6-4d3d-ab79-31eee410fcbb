document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    function getFieldError(field) {
      ...
      if (
        (type === 'tel' || name.toLowerCase().includes('phone')) &&
  ...
  const animatedClass = 'fade-in-element';
  const visibleClass = 'is-visible';

  // Auto-mark elements with data-animate attribute
  document.querySelectorAll('[data-animate]').forEach(function (el) {
    el.classList.add(animatedClass);
  });

  // Also support pre-marked elements
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'cfca09a5-e9c6-4d3d-ab79-31eee410fcbb',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'cfca09a5-e9c6-4d3d-ab79-31eee410fcbb';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'cfca09a5-e9c6-4d3d-ab79-31eee410fcbb';
